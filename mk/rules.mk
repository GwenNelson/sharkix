...
$(KERNEL_ELF): FORCE $(KERNEL_OBJECTS) $(USER_OBJECTS) $(LIBFIFO_ARTIFACT) $(KERNEL_LINK_LIBS) $(KERNEL_LINKER_SCRIPT)
	$(MKDIR_P) $(@D)
	$(LD) $(KERNEL_LDFLAGS) -o $@ $(KERNEL_OBJECTS) $(USER_OBJECTS) $(LIBFIFO_ARTIFACT) $(KERNEL_LINK_LIBS)
FORCE:

$(KERNEL_OBJ_ROOT)/%.o: $(KERNEL_SRC_ROOT)/%.c
	$(MKDIR_P) $(@D)
	$(CC) $(KERNEL_CFLAGS) -MMD -MP $(KERNEL_CPPFLAGS) -c $< -o $@

$(KERNEL_OBJ_ROOT)/%.o: $(KERNEL_SRC_ROOT)/%.S
	$(MKDIR_P) $(@D)
