...
{
    startup_reaper();
    program_start_options_t options = { .privilege = THREAD_PRIVILEGE_USER, .priority = THREAD_PRIORITY_NORMAL, .reap_on_exit = 1 };
    ...
    startup_kernel_thread(survivor_task, "survivor", THREAD_PRIORITY_NORMAL);
