...
{
    startup_reaper();
    program_start_options_t options = { .privilege = THREAD_PRIVILEGE_USER, .priority = tskIDLE_PRIORITY + 2, .reap_on_exit = 1 };
    ...
    startup_kernel_thread(survivor_task, "survivor", tskIDLE_PRIORITY + 2);
