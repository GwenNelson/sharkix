...
VGA_CONSOLED_EMBED_OBJECT  := $(KERNEL_OBJ_ROOT)/vga-consoled/ring3-embed.o
...
$(VGA_CONSOLED_ELF): $(DRIVER_RING3_ENTRY_OBJECT) $(VGA_CONSOLED_OBJECT) $(DRIVER_RING3_LINKER) $(VGA_CONSOLED_LIBSHARKIX)
	$(MKDIR_P) $(@D)
	$(LD) -m $(USER_LINKER_FORMAT) -nostdlib -o $@ \
		$(DRIVER_RING3_ENTRY_OBJECT) $(VGA_CONSOLED_OBJECT) $(VGA_CONSOLED_LIBSHARKIX) \
