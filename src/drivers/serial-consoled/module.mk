...
SERIAL_CONSOLED_ENTRY_SOURCE  := $(DRIVER_RING3_ENTRY)
...
SERIAL_CONSOLED_EMBED_OBJECT  := $(KERNEL_OBJ_ROOT)/serial-consoled/ring3-embed.o
...
$(SERIAL_CONSOLED_OBJECT): $(SERIAL_CONSOLED_SOURCE)
	$(MKDIR_P) $(@D)
	$(CC) $(DRIVER_RING3_CPPFLAGS) $(DRIVER_RING3_CFLAGS) -c $< -o $@

$(SERIAL_CONSOLED_ELF): $(DRIVER_RING3_ENTRY_OBJECT) $(SERIAL_CONSOLED_OBJECT) $(DRIVER_RING3_LINKER) $(SERIAL_CONSOLED_LIBSHARKIX)
	$(MKDIR_P) $(@D)
	$(LD) -m $(USER_LINKER_FORMAT) -nostdlib -o $@ \
		$(DRIVER_RING3_ENTRY_OBJECT) $(SERIAL_CONSOLED_OBJECT) $(SERIAL_CONSOLED_LIBSHARKIX) \
		-T $(DRIVER_RING3_LINKER)
