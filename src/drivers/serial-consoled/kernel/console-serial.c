...
// IPC
static ipc_endpoint_t serial_endpoint;
static cap_handle_t   serial_output_cap;

static ipc_endpoint_t serial_ready_endpoint;
static cap_handle_t   serial_ready_cap;

static cap_handle_t    serial_ier_cap;   // IER (Interrupt Enable) cap
static portio_handle_t serial_ier;

static cap_handle_t    serial_lcr_cap;   // LCR (Line Control) cap
static portio_handle_t serial_lcr;

static cap_handle_t    serial_mcr_cap;   // MCR (Modem Control) cap
static portio_handle_t serial_mcr;

static cap_handle_t    serial_iir_cap;   // IIR (Interrupt Identify) cap
static portio_handle_t serial_iir;

static cap_handle_t    serial_lsr_cap;   // LSR (Line Status) cap
static portio_handle_t serial_lsr;

static cap_handle_t    serial_com1_cap;  // the actual 3f8 port cap
static portio_handle_t serial_com1;
